...
public class Lobby {
    ...
    private Lobby(String nome, Deck deck, String modoJogo) {
        this.nome = nome;
        this.deck = deck;
    ...
    public static Lobby getInstance(String nome, Deck deck, String modoJogo) {
        if (instance == null) {
            instance = new Lobby(nome, deck, modoJogo);
        }
        return instance;
    }
    ...
    public boolean buscarAdversarioDupla(List<Lobby> lobbies) throws TimeOutException {
        if (modoJogo.equals("Modo Dupla")) {
            ...
            if (lobbiesDisponiveis.size() >= 2) {
                ...
                iniciarPartidaEmDupla(this, lobbiesDisponiveis.get(index1), lobbiesDisponiveis.get(index2),
                        lobbiesDisponiveis.get(index3));
                return true;
            } else {
                try {
    ...
    public void diminuirPontosVida(int dano) {
        if (dano >= 0) {
            ...
            System.out.println("Jogador " + this.getNome() + " sofreu " + dano + " pontos de dano. Pontos de vida restantes: "
                    + this.pontosVida);
        } else {
    ...
    public void adicionarCardCoins(int quantidadeCardCoins) {
        ...
        if (quantidadeCardCoins >= 0) {
            ...
            System.out.println("Jogador " + this.getNome() + " recebeu " + quantidadeCardCoins
                    + " Card Coins. Total de Card Coins agora: " + this.cardCoins);
        } else {
